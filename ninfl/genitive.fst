...
$genitive-exceptions$ = $genitive-special-cases$ ^-> ( __ [#POS##BM##Numbers##TMP#]+ <genitive> )
...
$genitive$ = $genitive-exceptions$ || $genitive-step1$ || $genitive-step2$ || $remove-genitive-ninfl$
$genitive$
