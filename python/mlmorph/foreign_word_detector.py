...
compiled_english_pattern_regex = list(map(re.compile, ENGLISH_PATTERNS))
...
def check_foreign_word(word):
    ...
    Args
    ----
        word : str, rword to check whether it is foreign word or not
...
def has_sure_patterns(word):
    for pattern in compiled_english_pattern_regex:
