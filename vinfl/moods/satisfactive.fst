...
$fake-past$ = <RB>:<past> ^-> ([<v><passive-voice><causative-voice>]+ __ [<satisfactive-mood>])
$remove-past$ = <past>:<RB> ^-> ([<v><passive-voice><causative-voice>]+ __ [<satisfactive-mood>])

$verb-suffix-map$ = {ു<infl_marker>}:{ല്ലോ<infl_marker>} |  {ു<infl_marker>}:{ുവല്ലോ<infl_marker>} | \
	{ി<infl_marker>} : {ിയല്ലോ<infl_marker>}

$satisfactive-mood-form$ = $verb-suffix-map$ ^-> ([#Consonants#]+ __ [#BM##TMP#<v><passive-voice><causative-voice><past>]+ <satisfactive-mood> )
